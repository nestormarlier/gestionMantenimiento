...
class StockAdmin(admin.ModelAdmin):
    ...
    list_filter = ('repuesto_id','equipo_asociado__nombre',)
        # Usar fields para definir el orden de los campos
    fieldsets = (
        ('Información del repuesto', {
            'fields': ('repuesto_id', 'descripcion','equipo_asociado','stock_real')
        }),
        ('Niveles de stock', {
    ...
    def save_model(self, request, obj, form, change):
        try:
            ...
            # Si pasa la validación, llamamos al método save() del modelo para guardar
               ...
               obj.save()
               messages.success(request, '¡El stock se ha guardado exitosamente!')
...
###################### color Repuesto ID ###########################
    ...
    def repuesto_id_css(self,obj):
        return format_html('<span class="{}">{}</span>', self.repuesto_id(obj), obj.repuesto_id)
...
admin.site.register(Equipo_Asociado,Equipo_AsociadoAdmin)
